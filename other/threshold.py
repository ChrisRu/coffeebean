...
parser.add_argument(
    '--camera', help='Camera devide number.', default=0, type=int)
args = parser.parse_args()
cap = cv.VideoCapture(args.camera)
cv.namedWindow(window_detection_name)
cv.resizeWindow(window_detection_name, 1280, 720)
...
while True:
    ...
    # ret, frame = cap.read()
    frame = cv.imread('bonen/Image__2019-04-29__03-03-16.bmp')
